...
if __name__ == '__main__':
    df1 = pd.read_csv("../analise_de_dados/ncvoter42.csv", sep=",", encoding="utf-8", keep_default_na=False)
    df2 = pd.read_csv("../analise_de_dados/ncvoter42_perturbed.csv", sep=",", encoding="utf-8", keep_default_na=False)
