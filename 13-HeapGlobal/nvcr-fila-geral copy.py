...
if __name__ == "__main__":
    ...
    df1 = pd.read_csv("../00-datasets/ncvoter42_prepared.csv", sep=",", encoding="utf-8", keep_default_na=False)
    df2 = pd.read_csv("../00-datasets/perturbed_recordsNC_voter_prepared.csv", sep=",", encoding="utf-8", keep_default_na=False)
